    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: "#F9FAFB" }}>
      ...
      <ScrollView>
        ...
        <View style={styles.content}>
          ...
          <Text style={styles.diaria}>
            Diária por pessoa: {alojamento.diaria}
          </Text>
          ...
          <TouchableOpacity
            onPress={() => openAction(`mailto:${alojamento.contato.email}`)}
          >
            <View style={styles.infoBox}>
          ...
          <TouchableOpacity
            onPress={() => openAction(`tel:${alojamento.contato.telefone}`)}
          >
            <View style={styles.infoBox}>
